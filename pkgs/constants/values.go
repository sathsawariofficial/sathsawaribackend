...
const (
	...
	NOTIFICATION_TYPE_SHIFT_CANCELLED       = "shift_cancelled"
	NOTIFICATION_TYPE_GROUP_REQUEST         = "group_request"
	NOTIFICATION_TYPE_GROUP_DECISION        = "group_decision"
)
...
func NewNotificationType(notificationType string) bool {
	...
	case NOTIFICATION_TYPE_RIDE_CREATED,
		...
		NOTIFICATION_TYPE_SHIFT_CANCELLED,
		NOTIFICATION_TYPE_GROUP_REQUEST,
		NOTIFICATION_TYPE_GROUP_DECISION:
		return true
	default:
		return false
	}
